    ...
    <div className="container-fluid" id="nav-container">
        ...
        <div className="collapse navbar-collapse w-100 d-md-flex justify-content-md-center" id="navigating-control">
            <ul className="navbar-nav d-md-flex ms-auto">
                <li className="nav-item mx-md-3"><Link to = "/boards" className="navbar-link btn btn-default">Projects</Link></li>
                <li className="nav-item mx-md-3"><Link to = "/profile" className="navbar-link btn btn-default">Profile</Link></li>
